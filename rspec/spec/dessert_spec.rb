...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect {Dessert.new("cake", "four", "chef ramsay")}.to raise_error(ArgumentError)
    end
  end

  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      dessert.add_ingredient("celery")
      expect(dessert.ingredients).to include("celery")
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef Gordon Ramsay the Great Baker has made 4 cakes!")
    end
  end
